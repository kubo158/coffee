'use strict'; {
  ...
  header.appendChild(divHWrapper);


  divHWrapper.appendChild(divHInner);
  divHInner.appendChild(notExist);
  notExist.appendChild(pHInner);

  divHInner.appendChild(divHTitle);
  divHTitle.appendChild(div);
  div.appendChild(imgHTitle);

  divHTitle.appendChild(h1);


  divHWrapper.appendChild(nav);
  nav.appendChild(ul);
